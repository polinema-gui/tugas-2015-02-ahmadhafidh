Public Class Form1
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles ButtonTambah.Click
        operasi = "+"
    End Sub

    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles ButtonKurang.Click
        operasi = "-"
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles ButtonBagi.Click
        operasi = ":"
    End Sub

    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles ButtonHapus.Click
        operasi = ""
        txtnilai1 = ""
        txtnilai2 = ""
        txtHasil.Clear()
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles ButtonHasil.Click
